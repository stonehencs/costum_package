...
def main():
    ...
    while True:
        user_input = input("Adjon meg egy 8-bites bináris számsort a ledeknek (pl. 10101010, vagy 'q' kilépéshez): ")
        ...
        user_input = input("Adjon meg egy 8-bites bináris számsort a anodnak  (pl. 10101010, vagy 'q' kilépéshez): ")
        if user_input.lower() == 'q':
            break
        if len(user_input) != 8 or not all(c in '01' for c in user_input):
            print("Hiba: Csak 8-bites bináris számot adjon meg!")
